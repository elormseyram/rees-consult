...
<head>
    ...
    <title>404 - Page Not Found | Rees Consult</title>
...
<body>
    <div class="error-container">
        ...
        <div class="helpful-links">
            ...
            <a href="{{ route('services.index') }}"><i class="bi bi-arrow-right me-2"></i>Our Services</a>
            <a href="{{ route('about') }}"><i class="bi bi-arrow-right me-2"></i>About Us</a>
            <a href="{{ route('blog.index') }}"><i class="bi bi-arrow-right me-2"></i>Blog</a>
            <a href="{{ route('scholarships.index') }}"><i class="bi bi-arrow-right me-2"></i>Scholarships</a>
        </div>
    </div>
</body>
</html>
