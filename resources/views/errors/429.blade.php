...
<head>
    ...
    <title>429 - Too Many Requests | Rees Consult</title>
...
<body>
    <div class="error-container">
        <i class="bi bi-speedometer error-icon"></i>
        ...
        <div class="info-box">
            <p><i class="bi bi-info-circle me-2"></i>This is a security measure to protect our services. Please try again in a few minutes.</p>
        </div>
